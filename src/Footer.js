function Footer() {
    ...
    return (
        <div className="navbar">
            <div className="footer-bg"><img src="/images/footer/BottomMenuBar.png" className="navbar-img"alt="" /></div>
            ...
            <div className="navbar-logo"><a href="#hero"><img src="/images/footer/LogoTextBottomMenuBar.png" alt="" /></a></div>
