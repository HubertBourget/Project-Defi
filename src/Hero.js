function Hero() {
    return (
        <div className="hero" id="hero">
            ...
            <div className="hero-text">Project defi is a very unique nft project. Built on the etherium blockchain. Join out movement and become the owners of the next blue chip project. It’s crazy how one nft could change your life. <br></br>Don’t forget to join our discord.</div>
